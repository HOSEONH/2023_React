...
export class EventComp extends Component {
    ...
    constructor(props){
        ...
        this.printAdress = this.printAdress.bind(this);
        this.setToggle = this.setToggle.bind(this);

        this.changeColor = this.changeColor.bind(this);
    }

    // 이벤트안에서 작성한 함수 그대로 들고와서 사용할 수 있다
    ...
    // this.setState통해서 컬러값 수정
    changeColor(e){
        // e : 이벤트 객체를 들고와서 e.type을 통해서 이벤트 구분가능
        // 이벤트의 type에 따라서 setState에 값 다르게 넣을 수 있다
    ...
    changeName = () => { // this를 연결해줄 필요없이 바로 
        this.setState({name:"🍈"});
    }

    // onChange 공용메소드
    onInputChange = (e)=>{
        // inputNickname을 그대로 사용 > inputNickname에만 값이 들어
    ...
    render() {
        ...
        return (
            ...
            <div>
                ...
                <button
                    // 실행할 함수 내용이 짧을 때 (화살표함수를 이용하여 바로 작성) 
                    // 이벤트 객체 사용가능
                    // this를 사용했을 때 자기자신 클래스 컴포넌트 호출
                    // > 클래스컴포넌트에서 사용하는 props과 state호출
                ...
                */}
                ...
                {/* change 공용 메소드 함수 만들기 : 사용하지 않아도 상관 x */}
